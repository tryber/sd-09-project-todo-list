function generateInput() {
  ...
  newInput.placeholder = 'Digite uma nova tarefa.';
...
function generateAddTaskButton() {
  ...
  newButton.innerText = 'Cria nova tarefa';
...
function generateRemoveAllTasksButton() {
  ...
  newButton.innerText = 'Apaga toda lista';
...
function generateRemoveCompletedTasksButton() {
  ...
  newButton.innerText = 'Apaga finalizados';
...
function generateSaveTasksButton() {
  ...
  newButton.innerText = 'Salva lista Tarefas';
...
function generateUpAndDownButtons() {
  ...
  upButton.innerText = 'Mover para cima';

  const downButton = document.createElement('button');
  downButton.id = 'mover-baixo';
  downButton.innerText = 'Mover para baixo';
...
function generateSelectedTaskButton() {
  ...
  selectedButton.innerText = 'Remover selecionado';
